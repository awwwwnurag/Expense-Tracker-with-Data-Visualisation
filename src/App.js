...
import { LocalStorageProvider, useExpenses } from './context/LocalStorageContext';
      ...
      <ThemeProvider theme={theme}>
        ...
        <Routes>
          ...
          <Route path="/" element={
            <Box sx={{ 
              minHeight: '100vh',
              background: darkMode ? 'linear-gradient(135deg, #121212 0%, #282828 100%)' : 'linear-gradient(135deg, #F7F7F7 0%, #E8F4F4 100%)',
              py: 4,
              display: 'flex',
              ...
              <Container maxWidth={false} sx={{ 
                ...
                background: darkMode ? 'rgba(30, 30, 30, 0.6)' : 'rgba(255, 255, 255, 0.2)', // Increased opacity in dark mode
                borderRadius: '20px',
